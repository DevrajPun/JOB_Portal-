...
class FrontController {
  ...
  static job_details = async (req, res) => {
    try {
      ...
      res.render("job_details", {
        ...
        e: email,
        jdetails: jobdetails,
        msg: req.flash("You have applied successfully for this job"),
      });
  ...
  static sendVerifymail = async (name, email, token) => {
    ...
    let info = await transporter.sendMail({
      ...
      html:
        "<p>Hii " +
        name +
        ',Please click here to <a href="http://localhost:1000/verifyLogin?token=' +
        token +
